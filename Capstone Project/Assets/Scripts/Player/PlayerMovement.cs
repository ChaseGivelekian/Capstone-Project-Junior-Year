...
namespace Player
{
    public class PlayerMovement : MonoBehaviour
    {
        ...
        private float coyoteTime; //variable to determine how much time the player can hang in the air before jumping

        private float _coyoteCounter; //variable to determine how much time passed since the player ran off the edge
